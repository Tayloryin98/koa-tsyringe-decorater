...
function loadConfig(filepath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const ret = (yield (_a = fullpath, Promise.resolve().then(() => __importStar(require(_a)))));
        return ret;
    });
}
function run() {
    const program = new commander_1.Command().option('-f, --file <file>');
